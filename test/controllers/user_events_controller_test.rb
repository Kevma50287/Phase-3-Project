...
class UserEventsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_event" do
    assert_difference("UserEvent.count") do
      post user_events_url, params: { user_event: { event_id: @user_event.event_id, isAdmin?: @user_event.isAdmin?, user_id: @user_event.user_id } }
    end
  ...
  test "should update user_event" do
    patch user_event_url(@user_event), params: { user_event: { event_id: @user_event.event_id, isAdmin?: @user_event.isAdmin?, user_id: @user_event.user_id } }
