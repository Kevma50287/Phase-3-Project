...
class CalendarsTest < ApplicationSystemTestCase
  ...
  test "should create calendar" do
    ...
    fill_in "Font", with: @calendar.font
    fill_in "Font color", with: @calendar.font_color
    fill_in "Font size", with: @calendar.font_size
    fill_in "Header color", with: @calendar.header_color
